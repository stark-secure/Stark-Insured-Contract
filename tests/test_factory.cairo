...
fn test_create_single_policy() {
    ...
    start_prank(CheatTarget::One(factory.contract_address), USER1());
    let policy_address = factory.create_policy(
        USER1(),
        'health_insurance',
        365_u64, // 1 year duration
        ASSET(),
        'salt1'
    );
    stop_prank(CheatTarget::One(factory.contract_address));
...
fn test_create_multiple_policies() {
    ...
    let policy1 = factory.create_policy(
        USER1(),
        'health_insurance',
        365_u64,
        ASSET(),
    ...
    let policy2 = factory.create_policy(
        USER1(),
        'car_insurance',
        180_u64,
        ASSET(),
    ...
    let policy3 = factory.create_policy(
        USER1(),
        'home_insurance',
        730_u64,
        ASSET(),
